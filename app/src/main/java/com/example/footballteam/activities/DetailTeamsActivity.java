...
public class DetailTeamsActivity extends AppCompatActivity {
    ...
    Integer idTeam;
    String Stadium, Date, Description, Country, LogoTeams, TeamName, SubName, Years, Youtube, Facebook, Twitter, Instagram, Website, Banner, StadiumDescription, StadiumName, StadiumLocation, StadiumCapacity;
                ...
                new MaterialFavoriteButton.OnFavoriteChangeListener() {
                    ...
                    public void onFavoriteChanged(MaterialFavoriteButton buttonView, boolean favorite) {
                        if (favorite) {
                            ...
                            helper.addFavoriteMovie(Stadium, Date, idTeam, Description, Country, LogoTeams, TeamName, SubName, Years, Youtube, Facebook, Twitter, Instagram, Website, Banner, StadiumDescription, StadiumName, StadiumLocation, StadiumCapacity);
                            Toast.makeText(DetailTeamsActivity.this, TeamName + " added to favorite", Toast.LENGTH_SHORT).show();
                        } else {
                            helper.deleteFavoriteMovie((modelMovie.getIdTeam()));
                            Toast.makeText(DetailTeamsActivity.this, TeamName + " removed from favorite", Toast.LENGTH_SHORT).show();
                        }
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(DetailTeamsActivity.this);
